 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".happy-clients__slider")) new core(".happy-clients__slider", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
        ...
        document.addEventListener("watcherCallback", (e => {
            if (e.detail.entry.target.classList.contains("statistics-page") && e.detail.entry.target.classList.contains("_watcher-view")) {
                outNum(847, document.querySelector("._animate-numbers_1 span"));
                outNum(753, document.querySelector("._animate-numbers_2 span"));
                outNum(284, document.querySelector("._animate-numbers_3 span"));
                outNum(98, document.querySelector("._animate-numbers_4 span"));
            }
        }));
        window["FLS"] = true;
        isWebp();
