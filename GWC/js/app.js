(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
            ...
            window.addEventListener("load", (function(e) {
                ...
                function initItem(showMoreBlock, matchMedia = false) {
                    ...
                    if (matchMedia.matches || !matchMedia) if (hiddenHeight < getOriginalHeight(showMoreContent)) {
                        ...
                        showMoreButton.classList.remove("_less-info");
                    } else {
                        _slideDown(showMoreContent, 0, hiddenHeight);
                        showMoreButton.classList.add("_less-info");
                    } else {
                        _slideDown(showMoreContent, 0, hiddenHeight);
        ...
        const headerLinks = document.querySelectorAll(".spollers-menu__link");
        headerLinks.forEach((link => {
            link.addEventListener("click", (() => {
                if (document.querySelector("header._active")) document.querySelector("header").classList.remove("_active");
                if (document.querySelector(".spollers-menu._active")) document.querySelector(".spollers-menu._active").classList.remove("_active");
            }));
        }));
