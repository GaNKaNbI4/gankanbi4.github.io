    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".clients-review-home__slider")) new core(".clients-review-home__slider", {
                ...
                speed: 1e3,
                pagination: {
                    el: ".clients-review-home__pagination",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            function slidersOnMobile(e) {
                if (e.matches) {
                    if (document.querySelector(".how-it-works-slider-first")) howItWorksSliderFirst = new core(".how-it-works-slider-first", {
                        modules: [ Pagination ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 1,
                    ...
                    if (document.querySelector(".how-it-works-slider-second")) howItWorksSliderSecond = new core(".how-it-works-slider-second", {
                        modules: [ Pagination ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 1,
                    ...
                    if (document.querySelector(".how-it-works-slider-third")) howItWorksSliderThird = new core(".how-it-works-slider-third", {
                        modules: [ Pagination ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 1,
                    ...
                    if (howItWorksSliderFirst) howItWorksSliderFirst.destroy(false);
                    if (howItWorksSliderSecond) howItWorksSliderSecond.destroy(false);
                    if (howItWorksSliderThird) howItWorksSliderThird.destroy(false);
                }
            }
