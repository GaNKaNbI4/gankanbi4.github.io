 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        if (currentPage.includes("game")) {
            ...
            if ("book-of-dead" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="book-of-dead" src='https://asccw.playngonetwork.com/Casino/IframedView?pid=2&amp;gid=bookofdead&amp;gameId=360&amp;lang=en_US&amp;practice=1&amp;channel=desktop&amp;div=flashobject&amp;width=100%&amp;height=100%&amp;user=&amp;password=&amp;ctx=&amp;demo=2&amp;brand=&amp;lobby=&amp;rccurrentsessiontime=0&amp;rcintervaltime=0&amp;rcaccounthistoryurl=&amp;rccontinueurl=&amp;rcexiturl=&amp;rchistoryurlmode=&amp;autoplaylimits=0&amp;autoplayreset=0&amp;callback=flashCallback&amp;rcmga=&amp;resourcelevel=0&amp;hasjackpots=False&amp;country=&amp;pauseplay=&amp;playlimit=&amp;selftest=&amp;sessiontime=&amp;coreweburl=https://asccw.playngonetwork.com/&amp;showpoweredby=True'></iframe>`; else if ("bonanza" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="bonanza" src="https://nogs-gl.nyxmalta.com/game/?nogsgameid=70206&nogsoperatorid=113&nogslang=en_us&clienttype=html5&nogsmode=demo&nogscurrency=GBP" scrolling="yes"></iframe>`; else if ("starburst" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="starburst" src="https://netentff-static.casinomodule.com/games/starburst_mobile_html/game/starburst_mobile_html.xhtml?gameId=starburst_not_mobile&amp;showHomeButton=false&amp;gameLocation=games%2Fstarburst_mobile_html%2F&amp;preBuiltGameRulesSupported=true&amp;server=https%3A%2F%2Fnetentff-game.casinomodule.com%2F&amp;lang=en&amp;sessId=DEMO-200624748-EUR&amp;operatorId=default" allow="autoplay;" autoplay=""></iframe>`; else if ("book-of-oz" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="book-of-oz" src="https://redirector32.valueactive.eu/Casino/Default.aspx?applicationid=4023&amp;sext1=demo&amp;sext2=demo&amp;serverid=22619&amp;gameid=bookOfOzDesktop&amp;ul=en&amp;variant=UAT-demo&amp;lobbyURL=http://quickfire.co.uk/games"></iframe>`; else if ("wolf-treasure" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id='wolf-treasure' frameborder="0" allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" hspace="0" vspace="0" scrolling="none" src="https://demogamesfree.intergamingtech.com/cwguestlogin.do?play_for_fun=true&amp;lang=en&amp;bankId=igBOG2&amp;gameId=1511853939&amp;"></iframe>`; else if ("cleopatra" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="cleopatra" src="https://platform.pa.rgsgames.com/skb/gateway?nscode=PENN&amp;technology=HTML&amp;softwareid=200-1173-001&amp;countrycode=US&amp;presenttype=STD&amp;skincode=PN03&amp;language=en&amp;channel=INT&amp;currencycode=FPY"></iframe>`;
        }
        window["FLS"] = false;
        isWebp();
        menuInit();
