 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        document.addEventListener("click", (e => {
            if (e.target.classList.contains("games-home__link")) {
                if (document.querySelector(".games-home__link._active") && document.querySelector(".games-home__link._active") != e.target) document.querySelector(".games-home__link._active").classList.remove("_active");
                e.target.classList.toggle("_active");
            } else if (document.querySelector(".games-home__link._active")) document.querySelector(".games-home__link._active").classList.remove("_active");
        }));
        ...
        document.addEventListener("formSent", (function(e) {
            e.detail.form;
            if (e.detail.form.classList.contains("popup__form")) location = "index.html";
        }));
        const currentPage = document.location.pathname;
        if (currentPage.includes("game")) {
            let params = new URL(document.location).searchParams;
            const nameParam = params.get("name");
            if ("book-of-dead" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="book-of-dead" src='https://asccw.playngonetwork.com/Casino/IframedView?pid=2&amp;gid=bookofdead&amp;gameId=360&amp;lang=en_US&amp;practice=1&amp;channel=desktop&amp;div=flashobject&amp;width=100%&amp;height=100%&amp;user=&amp;password=&amp;ctx=&amp;demo=2&amp;brand=&amp;lobby=&amp;rccurrentsessiontime=0&amp;rcintervaltime=0&amp;rcaccounthistoryurl=&amp;rccontinueurl=&amp;rcexiturl=&amp;rchistoryurlmode=&amp;autoplaylimits=0&amp;autoplayreset=0&amp;callback=flashCallback&amp;rcmga=&amp;resourcelevel=0&amp;hasjackpots=False&amp;country=&amp;pauseplay=&amp;playlimit=&amp;selftest=&amp;sessiontime=&amp;coreweburl=https://asccw.playngonetwork.com/&amp;showpoweredby=True'></iframe>`; else if ("bonanza" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="bonanza" frameborder="0" scrolling="no" allowfullscreen="" src="https://demogamesfree.pragmaticplay.net/gs2c/openGame.do?gameSymbol=vs20fruitsw&amp;websiteUrl=https%3A%2F%2Fdemogamesfree.pragmaticplay.net&amp;jurisdiction=99&amp;lobby_url=https%3A%2F%2Fwww.pragmaticplay.com%2Fen%2F" style="border:none;" src="https://demogamesfree.pragmaticplay.net/gs2c/openGame.do?gameSymbol=vs20fruitsw&amp;websiteUrl=https%3A%2F%2Fdemogamesfree.pragmaticplay.net&amp;jurisdiction=99&amp;lobby_url=https%3A%2F%2Fwww.pragmaticplay.com%2Fen%2F&amp;lang=EN&amp;cur=USD"></iframe>`; else if ("starburst" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="starburst" src="https://onlinegamespromo.fazi.rs/Home/IntegrationGameLaunch?moneyType=0&amp;gameName=StarGems"></iframe>`; else if ("book-of-oz" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="book-of-oz" src="https://redirector32.valueactive.eu/Casino/Default.aspx?applicationid=4023&amp;sext1=demo&amp;sext2=demo&amp;serverid=22619&amp;gameid=bookOfOzDesktop&amp;ul=en&amp;variant=UAT-demo&amp;lobbyURL=http://quickfire.co.uk/games"></iframe>`; else if ("wolf-treasure" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id='wolf-treasure' frameborder="0" allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" hspace="0" vspace="0" scrolling="none" src="https://demogamesfree.intergamingtech.com/cwguestlogin.do?play_for_fun=true&amp;lang=en&amp;bankId=igBOG2&amp;gameId=1511853939&amp;"></iframe>`; else if ("cleopatra" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="cleopatra" src="https://platform.pa.rgsgames.com/skb/gateway?nscode=PENN&amp;technology=HTML&amp;softwareid=200-1173-001&amp;countrycode=US&amp;presenttype=STD&amp;skincode=PN03&amp;language=en&amp;channel=INT&amp;currencycode=FPY"></iframe>`;
        }
        window["FLS"] = false;
        isWebp();
        menuInit();
