    ...
    (() => {
        ...
        document.addEventListener("click", (e => {
            if (e.target.closest(".item-slots-home__slot-ibg")) {
                if (document.querySelector(".item-slots-home__slot-ibg._clicked") && document.querySelector(".item-slots-home__slot-ibg._clicked") != e.target) document.querySelector(".item-slots-home__slot-ibg._clicked").classList.remove("_clicked");
                e.target.classList.toggle("_clicked");
            } else if (document.querySelector(".item-slots-home__slot-ibg._clicked")) document.querySelector(".item-slots-home__slot-ibg._clicked").classList.remove("_clicked");
        }));
