(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        const isLogged = localStorage.getItem("luckyKiwisSlotLogin");
        ...
        document.addEventListener("formSent", (function(e) {
            ...
            if (currentForm.classList.contains("popup__form")) {
                location = "index.html";
                localStorage.setItem("luckyKiwisSlotLogin", true);
            }
        }));
        const logoutButton = document.querySelector(".menu__button_logout");
        logoutButton.addEventListener("click", (() => {
            localStorage.removeItem("luckyKiwisSlotLogin");
            location = "index.html";
        }));
        ...
        if (currentPage.includes("game")) {
            ...
            if ("gates-of-olympus" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="gates-of-olympus" tabindex="0" frameborder="0" scrolling="no" style="border:none;" src="https://demogamesfree.pragmaticplay.net/gs2c/openGame.do?gameSymbol=vs20olympgate&amp;websiteUrl=https%3A%2F%2Fdemogamesfree.pragmaticplay.net&amp;jurisdiction=99&amp;lobby_url=https%3A%2F%2Fwww.pragmaticplay.com%2Fen%2F&amp;lang=EN&amp;cur=USD"></iframe>`; else if ("reactoonz" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="reactoonz" src="https://asccw.playngonetwork.com/casino/PlayMobile?pid=2&amp;gid=reactoonzmobile&amp;lang=en_GB&amp;server=&amp;practice=1"></iframe>`; else if ("the-dog-house" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="the-dog-house" tabindex="0" frameborder="0" scrolling="no" allowfullscreen="" style="border:none;" src="https://demogamesfree.pragmaticplay.net/gs2c/openGame.do?gameSymbol=vswaysdogs&amp;websiteUrl=https%3A%2F%2Fdemogamesfree.pragmaticplay.net&amp;jurisdiction=99&amp;lobby_url=https%3A%2F%2Fwww.pragmaticplay.com%2Fen%2F&amp;lang=EN&amp;cur=USD"></iframe>`; else if ("book-of-gods" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="book-of-gods" src="https://ogs-gcm-eu-stage.nyxop.net/gcm/gcm-launcher/launcher.html?gameUrl=https%3A%2F%2Fdga1sy052ek6h.cloudfront.net%2Fhtml5%2Fgcmwrapper.html%3Fenvid%3Deur%26stage%3D1&amp;gameid=bookofgods&amp;operatorid=241&amp;sessionid=Free%3Avjlid4b5slnm86t9s8q7nlajm5q&amp;currency=EUR&amp;lang=&amp;mode=demo&amp;secure=true&amp;type=nextgen&amp;clock=true&amp;device=desktop&amp;lobbyurl=http%3A%2F%2Fdemo.nyxinteractive.com%3Fsession%3D&amp;depositurl=&amp;quality=hq&amp;nyxroot=nogs-gdm-stage.nyxmalta.com/nextgen/&amp;"></iframe>`; else if ("elvis-frog-in-vegas" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="elvis-frog-in-vegas" frameborder="0" allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" hspace="0" vspace="0" scrolling="none" src="https://bgaming-network.com/games/ElvisFrog/FUN?play_token=9547f6f2-73e9-4389-8915-ca190f38c8af"></iframe>`; else if ("book-of-aztec" == nameParam) document.querySelector(".game__iframe").innerHTML = `<iframe id="book-of-aztec" src="https://cdn02.cdn.amatic.com/gmsl/amanet/game.html?game=bookofaztec&amp;hash=freeplay&amp;exit=ttps://stagedemo.oryxgaming.com&amp;wallet=w1&amp;language=en&amp;currency=EUR&amp;config=1359&amp;isFreeplay=true&amp;type=desktop&amp;allowfullscreen=true&amp;messageType=2&amp;isGameBridge=true"></iframe>`;
        }
        window["FLS"] = false;
        isWebp();
        menuInit();
