(() => {
    ...
    (() => {
        ...
        da.init();
        document.querySelector(".menu-header__close").addEventListener("click", (() => {
            functions_menuClose();
        }));
        document.querySelector(".chosen-filters-page__filter-button button").addEventListener("click", (() => {
            filtersOpen();
        }));
        document.querySelector(".menu-filters__close").addEventListener("click", (() => {
            filtersClose();
        }));
        ...
        window.addEventListener("resize", (() => {
            ...
            if (!mediaQuery.matches) {
                ...
                if (document.documentElement.classList.contains("filters-open")) filtersClose();
            }
        }));
        isWebp();
        menuInit();
