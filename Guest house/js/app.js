(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                ...
                document.querySelector(".menu-header__body").classList.toggle("_active");
            }
        }));
    }
    function menuClose() {
        ...
        document.querySelector(".menu-header__body").classList.remove("_active");
    }
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) myswiper = new core(".swiper", {
